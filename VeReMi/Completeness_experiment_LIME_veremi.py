...
attacker_type_0 = dataset[dataset['attackerType'] == 0]
attacker_type_1 = dataset[dataset['attackerType'] == 1]

# Display the separated datasets
print("Attacker Type 0:")
...
# Display the separated datasets without 'attackerType' column
print("Attacker Type 0:")
print(attacker_type_0)
...
print(p)
print('Number of anomalous samples that changed classification: ',p[0])
print('Number of all samples analyzed: ',p[1])
percentage = 100*p[0]/p[1]
print(percentage,'%','- samples are complete ')
...
# Plot the first line
plt.plot(x_axis, y_axis_anomalous, label='Anomalous', color='blue', linestyle='--', marker='o')
# # Plot the third line
plt.plot(x_axis, y_axis_benign, label='Benign', color='green', linestyle='--', marker='s')
