...
# df = df.drop(['spd_y','pos_x', 'spd_x','pos_y'], axis=1)
data_df=df
df.head()
...
explainer = shap.KernelExplainer(clf.predict, X_train_scaled)  
...
f:print('y_axis_KNN = ', Spar ,'')

print('x_axis_KNN = ', X_axis ,'')
...
print('LIME time for DT: ',(end - start))
