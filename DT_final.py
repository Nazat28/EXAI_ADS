...
#FOR DESCRIPTIVE ACCURACY FIRST RUN THE CODE TILL "INITIATING SPARSITY EXPERIMENT". THEN AFTER GETTING THE TOP FEATURES USE THE df.drop TO DROP THE TOP FEATURES AND RUN TILL THIS AGAIN. IN THIS WAY DESCRIPTIVE ACCURACY WITHOUT THE TOP-K FEATURES CAN BE GOT.   
# In[6]:
